...
<head>
    ...
    <title>Sistem Penggajian - SMK YAPIIM INDRAMAYU</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Sistem <sup>Gaji</sup></div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item">
                ...
                <div id="report" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="masyarakat_cetak.php">Data Masyarakat</a>
                        <a class="collapse-item" href="">Data Petugas</a>
                        <a class="collapse-item" href="laporan_pengaduan.php">Data Pengaduan</a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?php
                                    ...
                                    $petugas = mysqli_query($koneksi,"SELECT * FROM tb_petugas where id_petugas='$id_petugas'");
                                    while ($ptg = mysqli_fetch_array($petugas)){
                                        echo $ptg ['nama_petugas'];
                                        echo " ( ". $ptg ['level'] . " )";
                                ?>
                                <?php } ?>
                                </span>
